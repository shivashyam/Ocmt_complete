    ...
    describe('Faculty Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/faculties';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Faculty', () => {
                service.create(new Faculty(null)).subscribe(received => {
            ...
            it('should update a Faculty', () => {
                service.update(new Faculty(123)).subscribe(received => {
